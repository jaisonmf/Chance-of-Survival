...
public class goblin : MonoBehaviour
{
    ...
    public void Goblin()
    {
        ...
        go.GetComponent<enemyController>().minGold = cSVReader.myEnemyList.enemy[0].minGold;
        go.GetComponent<enemyController>().maxGold = cSVReader.myEnemyList.enemy[0].maxGold;
